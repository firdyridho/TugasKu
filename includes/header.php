...
<div class="app-layout">
    ...
    <nav class="mobile-bottom-nav" id="mobileBottomNav" role="navigation" aria-label="Navigasi utama">
        <div class="mobile-bottom-nav-inner">
            ...
            <a href="<?= BASE_URL ?>/jadwal/" class="mobile-nav-item <?= strpos($currentScript, 'jadwal') !== false ? 'active' : '' ?>" aria-label="Jadwal">
            ...
            <a href="<?= BASE_URL ?>/setting/" class="mobile-nav-item <?= strpos($currentScript, 'setting') !== false ? 'active' : '' ?>" aria-label="Pengaturan">
